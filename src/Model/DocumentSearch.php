...
class DocumentSearch implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['status']) && (strlen($this->container['status']) > 2)) {
            $invalidProperties[] = "invalid value for 'status', the character length must be smaller than or equal to 2.";
        }

        if (!is_null($this->container['status']) && (strlen($this->container['status']) < 1)) {
        ...
        if ((strlen($this->container['who']) < 1)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['status']) > 2) {
            return false;
        }
        ...
        if (strlen($this->container['status_display']) < 1) {
            return false;
        }
        if (strlen($this->container['parent_doc']) < 1) {
            return false;
        }
    ...
    {
        if (!is_null($status) && (strlen($status) > 2)) {
    ...
    public function setStatusDisplay($status_display)
    {
        ...
        if (!is_null($status_display) && (strlen($status_display) < 1)) {
    ...
    public function setParentDoc($parent_doc)
    {
        ...
        if (!is_null($parent_doc) && (strlen($parent_doc) < 1)) {
    ...
    public function setSubdomain($subdomain)
    {
        ...
        if (!is_null($subdomain) && (strlen($subdomain) < 1)) {
