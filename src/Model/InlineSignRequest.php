...
/**
 * InlineSignRequest Class Doc Comment
 *
 * @category Class
 * @package  SignRequest
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineSignRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InlineSignRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['who'], $allowedValues)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['from_email']) < 1) {
            return false;
        }
        if (strlen($this->container['from_email_name']) < 1) {
            return false;
        }
        if (strlen($this->container['prepare_url']) < 1) {
            return false;
        }
        if (strlen($this->container['redirect_url']) < 1) {
            return false;
        }
        if (strlen($this->container['subject']) < 1) {
            return false;
        }
        if (strlen($this->container['message']) < 1) {
            return false;
        }
        $allowedValues = $this->getWhoAllowableValues();
        if (!in_array($this->container['who'], $allowedValues)) {
    ...
    public function setFromEmail($from_email)
    {
        ...
        if (!is_null($from_email) && (strlen($from_email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $from_email when calling InlineSignRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFromEmailName($from_email_name)
    {
        ...
        if (!is_null($from_email_name) && (strlen($from_email_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $from_email_name when calling InlineSignRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPrepareUrl($prepare_url)
    {
        ...
        if (!is_null($prepare_url) && (strlen($prepare_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prepare_url when calling InlineSignRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRedirectUrl($redirect_url)
    {
        ...
        if (!is_null($redirect_url) && (strlen($redirect_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirect_url when calling InlineSignRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSubject($subject)
    {
        ...
        if (!is_null($subject) && (strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling InlineSignRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if (!is_null($message) && (strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling InlineSignRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        $allowedValues = $this->getWhoAllowableValues();
        if (!is_null($who) && !in_array($who, $allowedValues)) {
     ...
     * Sets send_reminders
     *
     * @param bool $send_reminders Automatically remind signers to sign a document
     *
     * @return $this
     */
    ...
    public function setUuid($uuid)
    {
        ...
        if (!is_null($uuid) && (strlen($uuid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling InlineSignRequest., must be bigger than or equal to 1.');
        }
