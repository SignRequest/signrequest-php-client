...
class SignRequestQuickCreate implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['external_id']) && (strlen($this->container['external_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'external_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['frontend_id']) && (strlen($this->container['frontend_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'frontend_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['file_from_url']) && (strlen($this->container['file_from_url']) > 2100)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['external_id']) > 255) {
            return false;
        }
        if (strlen($this->container['frontend_id']) > 255) {
            return false;
        }
        if (strlen($this->container['file_from_url']) > 2100) {
            return false;
        }
        if (strlen($this->container['events_callback_url']) > 2100) {
            return false;
        }
        if ($this->container['auto_delete_days'] > 730) {
            return false;
        }
        if ($this->container['auto_delete_days'] < 1) {
            return false;
        }
        return true;
    }
    ...
    {
        if (!is_null($external_id) && (strlen($external_id) > 255)) {
    ...
    {
        if (!is_null($frontend_id) && (strlen($frontend_id) > 255)) {
    ...
    {
        if (!is_null($file_from_url) && (strlen($file_from_url) > 2100)) {
