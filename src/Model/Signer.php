...
class Signer implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['verify_phone_number']) && (strlen($this->container['verify_phone_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'verify_phone_number', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['verify_bank_account']) && (strlen($this->container['verify_bank_account']) > 255)) {
            $invalidProperties[] = "invalid value for 'verify_bank_account', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['forwarded_to_email']) && (strlen($this->container['forwarded_to_email']) < 1)) {
            $invalidProperties[] = "invalid value for 'forwarded_to_email', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['forwarded_reason']) && (strlen($this->container['forwarded_reason']) < 1)) {
        ...
        if (!is_null($this->container['embed_url_user_id']) && (strlen($this->container['embed_url_user_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'embed_url_user_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['embed_url']) && (strlen($this->container['embed_url']) < 1)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['verify_phone_number']) > 255) {
            return false;
        }
        if (strlen($this->container['verify_bank_account']) > 255) {
            return false;
        }
        if (strlen($this->container['forwarded_to_email']) < 1) {
            return false;
        }
        if (strlen($this->container['forwarded_reason']) < 1) {
            return false;
        }
        if (strlen($this->container['message']) < 1) {
            return false;
        }
        if (strlen($this->container['embed_url_user_id']) > 255) {
            return false;
        }
        if (strlen($this->container['embed_url']) < 1) {
            return false;
        }
    ...
    {
        if (!is_null($verify_phone_number) && (strlen($verify_phone_number) > 255)) {
    ...
    {
        if (!is_null($verify_bank_account) && (strlen($verify_bank_account) > 255)) {
    ...
    public function setForwardedToEmail($forwarded_to_email)
    {
        ...
        if (!is_null($forwarded_to_email) && (strlen($forwarded_to_email) < 1)) {
    ...
    public function setForwardedReason($forwarded_reason)
    {
        ...
        if (!is_null($forwarded_reason) && (strlen($forwarded_reason) < 1)) {
    ...
    {
        if (!is_null($embed_url_user_id) && (strlen($embed_url_user_id) > 255)) {
    ...
    public function setEmbedUrl($embed_url)
    {
        ...
        if (!is_null($embed_url) && (strlen($embed_url) < 1)) {
