...
class SignRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['from_email']) && (strlen($this->container['from_email']) > 255)) {
        ...
        if (!is_null($this->container['from_email_name']) && (strlen($this->container['from_email_name']) > 255)) {
        ...
        if (!is_null($this->container['redirect_url']) && (strlen($this->container['redirect_url']) > 2100)) {
            $invalidProperties[] = "invalid value for 'redirect_url', the character length must be smaller than or equal to 2100.";
        }

        if (!is_null($this->container['subject']) && (strlen($this->container['subject']) > 512)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['from_email']) > 255) {
            return false;
        }
        if (strlen($this->container['from_email']) < 1) {
            return false;
        }
        if (strlen($this->container['from_email_name']) > 255) {
            return false;
        }
        if (strlen($this->container['prepare_url']) < 1) {
            return false;
        }
        if (strlen($this->container['redirect_url']) > 2100) {
            return false;
        }
        if (strlen($this->container['subject']) > 512) {
            return false;
        }
        $allowedValues = $this->getWhoAllowableValues();
        if (!in_array($this->container['who'], $allowedValues)) {
    ...
    {
        if (!is_null($from_email) && (strlen($from_email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $from_email when calling SignRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($from_email) && (strlen($from_email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $from_email when calling SignRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($from_email_name) && (strlen($from_email_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $from_email_name when calling SignRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setPrepareUrl($prepare_url)
    {
        ...
        if (!is_null($prepare_url) && (strlen($prepare_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prepare_url when calling SignRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($redirect_url) && (strlen($redirect_url) > 2100)) {
            throw new \InvalidArgumentException('invalid length for $redirect_url when calling SignRequest., must be smaller than or equal to 2100.');
        }
    ...
    {
        if (!is_null($subject) && (strlen($subject) > 512)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling SignRequest., must be smaller than or equal to 512.');
        }
    ...
    public function setUuid($uuid)
    {
        ...
        if (!is_null($uuid) && (strlen($uuid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling SignRequest., must be bigger than or equal to 1.');
        }
