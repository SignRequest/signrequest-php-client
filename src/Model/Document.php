...
class Document implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['file_as_pdf']) && (strlen($this->container['file_as_pdf']) < 1)) {
        ...
        if (!is_null($this->container['security_hash']) && (strlen($this->container['security_hash']) < 1)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['file_as_pdf']) < 1) {
            return false;
        }
        ...
        if (strlen($this->container['security_hash']) < 1) {
            return false;
        }
        return true;
    }
    ...
    public function setFileAsPdf($file_as_pdf)
    {
        ...
        if (!is_null($file_as_pdf) && (strlen($file_as_pdf) < 1)) {
    ...
    public function setSecurityHash($security_hash)
    {
        ...
        if (!is_null($security_hash) && (strlen($security_hash) < 1)) {
