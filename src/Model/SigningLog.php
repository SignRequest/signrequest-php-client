 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SigningLog implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SigningLog';
    ...
    public function setSecurityHash($security_hash)
    {
        ...
        if (!is_null($security_hash) && (strlen($security_hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $security_hash when calling SigningLog., must be bigger than or equal to 1.');
        }
